...
# Implements red tide detection method from Cannizzaro et al 2009
...
def Cannizzaro2009EtAlDetector(features):
	...
	red_tide_inds = np.where((features[:, 0]>=1.5) &  (bbp_555<=0.0045))
